...
<form method="GET" action="oracle-test.php"> <!--refresh page when submitted-->
    <input type="hidden" id="PrintNameRequest" name="PrintNameRequest">
    <input type="submit" name="PrintName"></p>
</form>
...
function handleGETRequest() {
    if (connectToDB()) {
        if (array_key_exists('countTuples', $_GET)) {
            handleCountRequest();
        } else if (array_key_exists('PrintName', $_GET)) {
            handlePrintRequest();
        }
...
if (isset($_POST['reset']) || isset($_POST['updateSubmit']) || isset($_POST['insertSubmit'])) {
    ...
    handleGETRequest();
} else if (isset($_GET['PrintNameRequest'])) {
    handleGETRequest();
}
?>
</body>
